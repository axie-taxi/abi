...
import type { LandContract, LandContractInterface } from "../LandContract";
...
export class LandContract__factory {
  static readonly abi = _abi;
  static createInterface(): LandContractInterface {
    return new utils.Interface(_abi) as LandContractInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LandContract {
    return new Contract(address, _abi, signerOrProvider) as LandContract;
  }
}
