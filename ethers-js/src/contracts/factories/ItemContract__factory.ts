...
import type { ItemContract, ItemContractInterface } from "../ItemContract";
...
export class ItemContract__factory {
  static readonly abi = _abi;
  static createInterface(): ItemContractInterface {
    return new utils.Interface(_abi) as ItemContractInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ItemContract {
    return new Contract(address, _abi, signerOrProvider) as ItemContract;
  }
}
