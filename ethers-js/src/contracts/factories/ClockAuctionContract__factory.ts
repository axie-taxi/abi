...
import type {
  ...
  ClockAuctionContractInterface,
} from "../ClockAuctionContract";
...
export class ClockAuctionContract__factory {
  static readonly abi = _abi;
  static createInterface(): ClockAuctionContractInterface {
    return new utils.Interface(_abi) as ClockAuctionContractInterface;
  }
  static connect(
    address: string,
