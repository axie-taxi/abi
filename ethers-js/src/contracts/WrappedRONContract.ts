...
export interface WrappedRONContractInterface extends utils.Interface {
  contractName: "WrappedRONContract";
  functions: {
...
export interface WrappedRONContract extends BaseContract {
  contractName: "WrappedRONContract";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WrappedRONContractInterface;
