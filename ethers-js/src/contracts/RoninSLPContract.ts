...
export interface RoninSLPContractInterface extends utils.Interface {
  contractName: "RoninSLPContract";
  functions: {
    ...
    "checkpoint(address,uint256,uint256,bytes)": FunctionFragment;
    "checkpointAndCall(uint256,uint256,bytes,address,uint256,bytes)": FunctionFragment;
    "dailyPotionLimit()": FunctionFragment;
    "decimals()": FunctionFragment;
    "getCheckpoint(address)": FunctionFragment;
    ...
    "setDailyPotionLimit(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "checkpointAndCall",
    values: [
      BigNumberish,
      BigNumberish,
      BytesLike,
  ...
  encodeFunctionData(
    functionFragment: "dailyPotionLimit",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setDailyPotionLimit",
    values: [BigNumberish]
  ): string;
  ...
  events: {
    ...
    "BreedingPotionCheckpoint(address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "BreedingPotionCheckpoint"): EventFragment;
...
export type BreedingPotionCheckpointEvent = TypedEvent<
  [string, BigNumber],
  { _owner: string; _amount: BigNumber }
>;

export type BreedingPotionCheckpointEventFilter =
  TypedEventFilter<BreedingPotionCheckpointEvent>;
...
export interface RoninSLPContract extends BaseContract {
  contractName: "RoninSLPContract";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RoninSLPContractInterface;
  ...
  functions: {
    ...
    dailyPotionLimit(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    setDailyPotionLimit(
      _dailyPotionLimit: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "BreedingPotionCheckpoint(address,uint256)"(
      _owner?: string | null,
      _amount?: BigNumberish | null
    ): BreedingPotionCheckpointEventFilter;
  ...
  populateTransaction: {
    ...
    dailyPotionLimit(overrides?: CallOverrides): Promise<PopulatedTransaction>;
