...
export interface KatanaRouterInterface extends utils.Interface {
  contractName: "KatanaRouter";
  functions: {
...
export interface KatanaRouter extends BaseContract {
  contractName: "KatanaRouter";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KatanaRouterInterface;
